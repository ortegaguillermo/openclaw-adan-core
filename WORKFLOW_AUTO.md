...
- **Blocked Mode:** If autonomy policy blocks work, log to memory and move to next task silently (do not escalate as blocker unless policy.logBlockedActions requires notification).
